          ...
          <form onSubmit={onSubmit}>
            ...
            <EditorialInput id="password" type={showPassword ? "text" : "password"} label="Password" value={password} onChange={setPassword}>
              <button
                ...
                className="absolute right-0 bottom-2 max-sm:bottom-0 flex items-center justify-center w-4 h-4 max-sm:w-11 max-sm:h-11 text-muted-foreground hover:text-foreground transition-colors"
              >
