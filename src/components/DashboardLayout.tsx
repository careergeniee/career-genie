            ...
            <aside
                ...
                <div className="relative flex items-center gap-1 px-4 py-5">
                    ...
                    <button
                        ref={closeButtonRef}
                        onClick={() => setSidebarOpen(false)}
                        className="ml-auto w-11 h-11 lg:w-7 lg:h-7 flex items-center justify-center rounded-lg hover:bg-white/10 text-dash-sidebar-foreground transition-colors"
            ...
            <main className="flex-1 overflow-auto min-w-0">
                ...
                <div className="sticky top-4 z-30 mx-4 mb-2 flex items-center gap-3 h-16 px-3 pl-5 rounded-full bg-foreground/90 backdrop-blur-md shadow-[0_8px_30px_rgba(0,0,0,0.25)]">
                    <button
                        ...
                        className="w-11 h-11 lg:w-10 lg:h-10 flex items-center justify-center rounded-full hover:bg-background/10 text-background transition-colors"
